<template>
  <div class="tab_home">
    ...
    <van-panel>
      <van-card :thumb-link="goDetail(groupGood.goodsId)"
                ...
                @native-click="goDetail(groupGood.goodsId)">
        <!--<router-link :to="{ path: `/items/detail/${groupGood.goodsId}`}"/>-->
        ...
        <van-cell-group>
          <van-cell title="人气推荐"
            ...
            <router-link to="/items/hot"
                         class="text-desc">人气推荐</router-link>
          </van-cell>
        </van-cell-group>
      </div>
    </van-panel>

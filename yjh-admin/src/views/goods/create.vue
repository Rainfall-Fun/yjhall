<template>
  <div class="app-container">
    ...
    <el-card class="box-card">
      ...
      <el-dialog :visible.sync="productVisiable" title="设置规格属性值">
        <el-form
          ref="productForm"
          :model="productForm"
          status-icon
...
<script>
import { getGoodsAttribute,publishGoods, listCatAndBrandAndSupplier } from '@/api/goods'
import { createStorage, uploadPath,deleteStorage } from '@/api/storage'
...
export default {
  ...
  data() {
    return {
      ...
      productForm: { id: 0, specifications: [], price: 0.00,costPrice:0.00,number:0,biggestDeductionAmount:0.00, url: '' },
  ...
  methods: {
    ...
    handleRemove: function(file, fileList) {
      ...
      deleteStorage(file.response.data).then(response => {

    ...
    getList() {
      ...
      listAddress(this.listQuery).then(response => {
        ...
        for(var i=0;i<tempList.length;i++){
          var tempAddress={};
          tempAddress.id=tempList[i].dzbm;
          tempAddress.userId=tempList[i].yhbm;
          tempAddress.name=tempList[i].shdr;
          tempAddress.tel=tempList[i].dhhm;
          tempAddress.province=tempList[i].sheng;
          tempAddress.city=tempList[i].shi;
          tempAddress.county=tempList[i].xian;
          tempAddress.addressDetail=tempList[i].shdz;
          tempAddress.isDefault=tempList[i].sfsmrdz==1?true:false;
          this.list.push(tempAddress);

<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      <el-table-column align="center" label="角色编码" prop="jsbm"/>
      <el-table-column align="center" label="角色名称" prop="jsmc"/>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="dataForm" status-icon label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
        <el-form-item label="角色名称" prop="jsmc">
          <el-input v-model="dataForm.jsmc"/>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handlePermission(row) {
      ...
      this.permissionForm.jsbm = row.jsbm
      getPermission({ roleId: row.jsbm })
        .then(response => {

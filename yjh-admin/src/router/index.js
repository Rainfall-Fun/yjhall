...
export const asyncRouterMap = [
...

  {
    ...
    {
      path: 'extensionAttribute',
        component: () => import('@/views/mall/extensionAttribute'),
      name: 'extensionAttribute',
      meta: {
      perms: ['GET /admin/extensionAttribute/list', 'POST /admin/extensionAttribute/create', 'GET /admin/extensionAttribute/read', 'POST /admin/extensionAttribute/update', 'POST /admin/extensionAttribute/delete'],
        title: '商品扩展属性',
        noCache: true
    }
    },
    {
      path: 'categoryExtension',
        component: () => import('@/views/mall/categoryExtension'),
      name: 'categoryExtension',
      meta: {
      perms: ['GET /admin/categoryExtension/list','POST /admin/extensionAttribute/add','POST /admin/extensionAttribute/delete'],
        title: '商品分类扩展属性',
        noCache: true
    }
    },
    ...
    children: [
      {
        ...
        name: 'goodsList',
        meta: {
          perms: ['GET /admin/goods/list', 'POST /admin/goods/delete','GET /admin/goods/detail'],
          title: '商品列表',
          noCache: true
        }
      },
...

  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'configExpress',
        meta: {
          perms: ['GET /admin/express/list','POST /admin/express/update','POST /admin/express/create','POST /admin/express/delete'],
          title: '运费配置',
          noCache: true
        }
      },
    {
      path: 'paymentWay',
        component: () => import('@/views/config/paymentWay'),
      name: 'configPaymentWay',
      meta: {
      perms: ['GET /admin/PaymentWay/list', 'POST /admin/paymentWay/create','POST /admin/paymentWay/delete','POST /admin/paymentWay/update'],
        title: '支付方式配置',
        noCache: true
    }
    },
